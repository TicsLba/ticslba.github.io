...
public class GateActivity extends Activity {
    ...
    @Override protected void onResume(){super.onResume();if(!PolicyManager.owner(this)||!Store.configured(this))return;if(Store.STATE_CREATING.equals(Store.state(this))){Store.state(this,Store.STATE_GATE);PolicyManager.applyOwnerGate(this);PolicyManager.startGateLock(this);startAgent();showGate();}else PolicyManager.startGateLock(this);}
