...
final class Managed{
 ...
 static void exit(Activity a){if(!owner(a))return;try{a.stopLockTask();}catch(Exception ignored){}try{dpm(a).setStatusBarDisabled(admin(a),false);}catch(Exception ignored){}}
