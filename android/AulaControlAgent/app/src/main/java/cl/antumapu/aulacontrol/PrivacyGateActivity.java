...
public class PrivacyGateActivity extends Activity{
 ...
 void showNotice(){
  ...
  TextView foot=t("Aula Móvil 2.0 · Gestión de aula y dispositivos",12,false,MUTED);foot.setGravity(Gravity.CENTER);foot.setPadding(0,dp(12),0,0);root.addView(foot);setContentView(sc);
 }
