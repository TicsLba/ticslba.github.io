...
public sealed class TelemetryStore
{
    ...
    {
        dir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "PANGI", "telemetry");
    ...
    public string ExportCsv(string deviceId, TimeSpan period)
    {
        ...
        var outDir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "PANGI", "Informes");
