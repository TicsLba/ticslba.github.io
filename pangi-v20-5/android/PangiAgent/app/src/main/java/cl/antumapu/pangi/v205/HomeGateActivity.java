 ...
 *
 * PANGI makes this the HOME target while access is gated. In the owner
...
public class HomeGateActivity extends Activity {
    ...
    private void render(){
        ...
        TextView title=text("PANGI",30,true,Color.WHITE);
        ...
        TextView boot=text("Arranque protegido · PANGI 20.5",11,true,Color.rgb(173,197,244));
