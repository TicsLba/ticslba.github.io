...
public class InstallResultReceiver extends BroadcastReceiver {
    @Override public void onReceive(Context c,Intent i){
        ...
        String ch="install";
        if(Build.VERSION.SDK_INT>=26&&nm.getNotificationChannel(ch)==null)nm.createNotificationChannel(new NotificationChannel(ch,"PANGI · instalaciones",NotificationManager.IMPORTANCE_DEFAULT));
        ...
        b.setSmallIcon(status==PackageInstaller.STATUS_SUCCESS?android.R.drawable.stat_sys_download_done:android.R.drawable.stat_notify_error)
         ...
         .setContentText(msg==null?"PANGI recibió el resultado del instalador":msg);
